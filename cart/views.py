    ...
    def post(self, request):
        ...
        try:
            ...
            if order_item.is_valid(raise_exception=False):
                order_item = order_item.save(validated_data = data)
                self.response['status'] = True
                self.response['order_item'] = order_items_details([order_item])
            else:
...
class OrderDetail(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            if not order.exists():
                self.response['order_item'] = f"You have not made any orders yet"
            else:
